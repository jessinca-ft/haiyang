...
lang:"en-US",setText:"确定",cancelText:"取消",ariaDesc:"Select a value",scrollLock:!0,tap:!0,speedUnit:0.0012,timeUnit:0.1,formatResult:function(a){return a.join(" ")},parseValue:function(b,c){var g=b.split(" "),k=[],y=0,h;a.each(c.settings.wheels,function(c,b){a.each(b,function(c,b){b=b.values?b:F(b);h=b.keys||b.values;-1!==a.inArray(g[y],h)?k.push(g[y]):k.push(h[0]);y++})});return k}};a(function(){o=a('<div class="dw-hidden" role="alert"></div>').appendTo("body")});a(document).on("mouseover mouseup mousedown click",
